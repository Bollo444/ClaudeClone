...
// Always ask when ClaudeClone tries to edit its own config files
 ...
 * This is a per-user temporary directory used by ClaudeClone for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by ClaudeClone)
