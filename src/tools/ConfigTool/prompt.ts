...
export const DESCRIPTION = 'Get or set ClaudeClone configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set ClaudeClone configuration settings.

  View or change ClaudeClone settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
