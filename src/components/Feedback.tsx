      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              ClaudeClone&apos;s functionality (eg. to reduce the risk of bugs
