...
/**
 * Resolve ClaudeClone-specific path patterns for sandbox-runtime.
 *
 * ClaudeClone uses special path prefixes in permission rules:
...
/**
 * Convert ClaudeClone settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where ClaudeClone started)
