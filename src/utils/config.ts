...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when ClaudeClone was first started on this machine
  ...
  // ClaudeClone usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first ClaudeClone OAuth token
  ...
  // ClaudeClone hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
