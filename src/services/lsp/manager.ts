 ...
 * Initialized during ClaudeClone startup.
 */
 ...
 * asynchronously during ClaudeClone startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during ClaudeClone startup. It synchronously creates
 ...
 *
 * This should be called during ClaudeClone shutdown. Stops all running LSP servers
